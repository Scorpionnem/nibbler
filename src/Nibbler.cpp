...
Client::~Client() {if (_fd != -1) {::close(_fd);}}

void	Client::connect(const char *addr, int port)
{
...
ssize_t	Client::recv(uint8_t *data, ssize_t size)
{
...
void	Client::send(const uint8_t *data, uint64_t size)
{
